 ...
 *      information</a>
 */
public class GCombo extends Composite {
	...
	// PSD - check prefix
	static final String PACKAGE_PREFIX = "no.esito.genova.ui.widget."; //$NON-NLS-1$
	 ...
	 * @see Widget#getStyle()
	 */
	public GCombo(Composite parent, int style) {
