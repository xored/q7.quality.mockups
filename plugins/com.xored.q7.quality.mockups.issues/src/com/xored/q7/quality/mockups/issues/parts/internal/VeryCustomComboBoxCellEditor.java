 ...
 * </p>
 */
public class VeryCustomComboBoxCellEditor extends AbstractComboBoxCellEditor {
	 ...
	 * @see VeryCustomComboBoxCellEditor#setItems
	 * @see CellEditor#dispose
	 */
	public VeryCustomComboBoxCellEditor() {
	 ...
	 */
	public VeryCustomComboBoxCellEditor(Composite parent, String[] items) {
	 ...
	 * @since 2.1
	 */
	public VeryCustomComboBoxCellEditor(Composite parent, String[] items, int style) {
		super(parent, style);
		setItems(items);
	}
	...
	protected Control createControl(Composite parent) {
		...
		comboBox = new VeryCustomCombo(parent, getStyle());
		...
		comboBox.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				VeryCustomComboBoxCellEditor.this.focusLost();
			}
		});
		return comboBox;
	}
