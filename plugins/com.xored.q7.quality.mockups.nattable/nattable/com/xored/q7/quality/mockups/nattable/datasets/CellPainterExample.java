...
import com.xored.q7.quality.mockups.nattable.datasets.person.ExtendedPersonWithAddress;
import com.xored.q7.quality.mockups.nattable.datasets.person.Person.Gender;
...
public class CellPainterExample {
    ...
    class PainterConfiguration extends AbstractRegistryConfiguration {
        ...
        private void registerColumnSevenCheckboxPainter(IConfigRegistry configRegistry) {
            configRegistry.registerConfigAttribute(
                    ...
                    new CheckBoxPainter(),
                    DisplayMode.NORMAL,
                    CellPainterExample.COLUMN_SEVEN_LABEL);
        ...
        private void registerColumnTenComboBoxPainter(IConfigRegistry configRegistry) {
            configRegistry.registerConfigAttribute(
                    ...
                    new ComboBoxPainter(),
                    DisplayMode.NORMAL,
                    CellPainterExample.COLUMN_TEN_LABEL);
        }
